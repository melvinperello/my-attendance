...
import { login, check, preRegister, register,logAttendance,checkAttendance,groupie } from "./fun";
  ...
  function (isolated, opts, done) {
    isolated.addHook("onSend", async function (request, reply) {
      reply.headers({
        ...
        "Content-Security-Policy":"default-src 'self' cdn.jsdelivr.net code.jquery.com",
